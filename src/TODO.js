...
//TODO 19. [_]  [add_empty_row]: Подумать над пустыми значениями, вместо отсутствия ключей
...
//TODO 24. [_]  Выполнить: При первичном рендере - загружать данные с сервера (conf.txt), при дальнешем - LocalDB/MongoDB => сохранять и отображать данные из БД
...
//TODO 27. [_]  Выполнить: Выделение строки по нажатии на нее
...
//TODO 36. [±]  Добавить кнопку shutdown в таблицу интерфейсов
//TODO 37.      Перекинуть удаление localStorage в главную страницу (App.js)
//TODO 38.      При переходе между вкладками, рендерить последюю страницу таблицы (если во вкладке таблица) || Или показывать последнюю используемую страницу
//TODO 39. [×]  Вынести всю логику для таблиц (обновление данных, подсчет страниц, обработчики и т.п.) в отдельную компоненту
//TODO 40.      Вынести таблицы в отдельный компонент с логикой